...
namespace WpfDraw.Model
{
    class DrawModel
    {
        ...
        private double currentShapeWidth;
        private double currentShapeHeight;
        private double currentShapeStartY;
        private double currentShapeStartX;
        private double currentShapeEndX;
        private double currentShapeEndY;
        ...
        {
            offset = new Point(position.X - startPosition.X, position.Y - startPosition.Y);
            currentShapeWidth = currentShape.Key.Area.Width;
            currentShapeHeight = currentShape.Key.Area.Height;
            currentShapeStartX = currentShape.Key.Start.X;
            currentShapeStartY = currentShape.Key.Start.Y;
            currentShapeEndX = currentShape.Key.End.X;
            currentShapeEndY = currentShape.Key.End.Y;
        }
        ...
        internal void ResizeShape(Point position, Modus modus)
        {
            switch (modus)
            {
                ...
                case Modus.TopCenter:
                    ...
                    {
                        currentShapeStartX = currentShape.Key.Start.X - (currentShapeHeight / 2 - currentShape.Key.Area.Height / 2) * Math.Sin(Math.PI / 180 * currentShape.Key.Rotation);
                ...
                case Modus.CenterLeft:
                    ...
                    {
                        currentShapeStartY = currentShape.Key.Start.Y + (currentShapeWidth / 2 - currentShape.Key.Area.Width / 2) * Math.Sin(Math.PI / 180 * currentShape.Key.Rotation);
        ...
        private void ResizeCenterRight(Point position)
        {
            ...
            double positionCenterRightY = currentShapeStartY - (currentShapeWidth / 2 - currentShape.Key.Area.Width / 2) * Math.Sin(Math.PI / 180 * currentShape.Key.Rotation);
            currentShape.Key.Start = new Point(currentShape.Key.Start.X, positionCenterRightY);
            currentShape.Key.End = new Point(positionCenterRightX, positionCenterRightY+currentShapeHeight);
        ...
        private void ResizeCenterLeft(Point position)
        {
            ...
            double positionCenterLeftY = currentShapeStartY + (currentShapeWidth / 2 - currentShape.Key.Area.Width / 2) * Math.Sin(Math.PI / 180 * currentShape.Key.Rotation);
            currentShape.Key.Start = new Point(positionCenterLeftX, positionCenterLeftY);
            currentShape.Key.End = new Point(currentShape.Key.End.X, positionCenterLeftY + currentShapeHeight);
            currentShape.Key.RotationCenter = new Point(currentShape.Key.Start.X + currentShape.Key.Area.Width / 2, currentShape.Key.Start.Y + currentShape.Key.Area.Height / 2);
            OnShapeChanged(currentShape.Key, currentShape.Value, false);
        }
        ...
        private void ResizeBottomCenter(Point position)
        {
            ...
            double positionBottomCenterX = currentShapeStartX + (currentShapeHeight / 2 - currentShape.Key.Area.Height / 2) * Math.Sin(Math.PI / 180 * currentShape.Key.Rotation);
            currentShape.Key.Start = new Point(positionBottomCenterX, currentShape.Key.Start.Y);
            currentShape.Key.End = new Point(positionBottomCenterX + currentShapeWidth, positionBottomCenterY);
            currentShape.Key.RotationCenter = new Point(currentShape.Key.Start.X + currentShape.Key.Area.Width / 2, currentShape.Key.Start.Y + currentShape.Key.Area.Height / 2);
            OnShapeChanged(currentShape.Key, currentShape.Value, false);
        }
        ...
        private void ResizeTopCenter(Point position)
        {
            ...
            double positionTopCenterX = currentShapeStartX - (currentShapeHeight / 2 - currentShape.Key.Area.Height / 2) * Math.Sin(Math.PI / 180 * currentShape.Key.Rotation);
            currentShape.Key.Start = new Point(positionTopCenterX, positionTopCenterY);
            currentShape.Key.End = new Point(positionTopCenterX + currentShapeWidth, currentShape.Key.End.Y);
            currentShape.Key.RotationCenter = new Point(currentShape.Key.Start.X + currentShape.Key.Area.Width / 2, currentShape.Key.Start.Y + currentShape.Key.Area.Height / 2);
            OnShapeChanged(currentShape.Key, currentShape.Value, false);
        }
